...
export const updateWeather = function (lat, lon) {
    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        card.innerHTML = `
                    <h2 class="title-2 card-title">Actuellement</h2>
        ...
        fetchData(url.airPollution(lat, lon), function (airPollution) {
            ...
            card.innerHTML = `
                        <h2 class="title-2" id="highlights-label">Aujourd'hui</h2>
                        ...
                        <div class="highlight-list">
                            ...
                            <div class="card card-sm highlight-card two">
                                ...
                                <h3 class="title-3">Lever et coucher du soleil</h3>
                            ...
                            <div class="card card-sm highlight-card">
                                ...
                                <h3 class="title-3">Ressentie</h3>

                                <div class="wrapper">
                                    <span class="m-icon">thermostat</span>

                                    <p class="title-1">${parseInt(feels_like)}<sup>&deg;</sup>c</p>
                                </div>
        ...
        fetchData(url.forecast(lat, lon), function (forecast) {
            ...
            forecastSection.innerHTML = `
                            <h2 class="title-2" id="forecast-label">Prévision sur 5 jours</h2>
